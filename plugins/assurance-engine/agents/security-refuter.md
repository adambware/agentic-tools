...
Review **independently**: re-read the actual code. Do not just sanity-check the prose. If the first reviewer cited `SiteController.php:88`, open it and verify the claim from source.
