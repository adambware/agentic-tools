...
function resolveDesignLane(input) {
  ...
  if (!filled(baseUrl)) {
    return {
      ok: false,
      reason: `manifest.stack_adapter.browser.base_url is missing or blank in ${manifestPath} \u2014 set it to the local dev / seeded staging URL the design lane should drive (never production)`
    };
  }
