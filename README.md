...
| [dev-doctor](plugins/dev-doctor/) | Skill | Read-only environment preflight — inspects git/worktree, runtimes, Docker/Compose, ports, volumes, and env files before you code |
